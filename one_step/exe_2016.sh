...
# copied from https://cms-pdmv.cern.ch/mcm/chained_requests?contains=EXO-RunIISummer20UL16MiniAODv2-02120&page=0&shown=15
...
cmsDriver.py  --python_filename RECO_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:reco.root --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:hlt.root --era Run2_2016 --runUnscheduled --mc --nThreads $NTHREAD -n $NEVENT || exit $? ;

## Run MiniAODv2 with -j FrameworkJobReport.xml 
cmsDriver.py  --python_filename MiniAODv2_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:miniv2.root --conditions 106X_mcRun2_asymptotic_v17 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:reco.root --era Run2_2016 --runUnscheduled --mc --nThreads $NTHREAD -n $NEVENT || exit $? ;

# uncomment if need to produce miniaod
# cmsDriver.py  --python_filename MiniAODv2_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:miniv2.root --conditions 106X_mcRun2_asymptotic_v17 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:reco.root --era Run2_2016 --runUnscheduled --mc --nThreads $NTHREAD -n $NEVENT --no-exec || exit $? ;
# cmsRun -j FrameworkJobReport.xml MiniAODv2_cfg.py

# comment if need to produce miniaod
## Run NanoAODv9
cmsDriver.py  --python_filename NanoAODv9_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nanov9.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein file:miniv2.root --era Run2_2016,run2_nanoAOD_106Xv2 --mc --nThreads $NTHREAD -n $NEVENT --no_exec || exit $? ;
