...
# copied from https://cms-pdmv.cern.ch/mcm/chained_requests?contains=EXO-RunIISummer20UL18MiniAODv2-02230&page=0&shown=15
...
# cmsDriver.py  --python_filename MiniAODv2_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:miniv2.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:reco.root --era Run2_2018 --runUnscheduled --mc --nThreads $NTHREAD -n $NEVENT --no-exec || exit $? ;
# cmsRun -j FrameworkJobReport.xml MiniAODv2_cfg.py

# comment if need to produce miniaod
## Run NanoAODv9
cmsDriver.py  --python_filename NanoAODv9_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nanov9.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step NANO --filein file:miniv2.root --era Run2_2018,run2_nanoAOD_106Xv2 --mc --nThreads $NTHREAD -n $NEVENT --no_exec || exit $? ;
